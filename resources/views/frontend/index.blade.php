                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="button-head">
                                                <div class="product-action">
                                                    <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Ver</span></a>
                                                    <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" ><i class=" ti-heart "></i><span>Agregar a la lista de deseos</span></a>
                                                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            <div class="content">
                                ...
                                <a href="{{route('product-detail',$data->slug)}}">Compra Ahora</a>
                            </div>
                        </div>
                    </div>
                    <!-- /End Single Banner  -->
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="shop-single-blog">
                            ...
                            <div class="content">
                                ...
                                <a href="{{route('blog.detail',$post->slug)}}" class="more-btn">Continua leyendo</a>
                            </div>
                        </div>
                        <!-- End Single Blog  -->
                    </div>
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            ...
                                            <div class="quickview-stock">
                                                ...
                                                @else
                                                <span><i class="fa fa-times-circle-o text-danger"></i> {{$product->stock}} Sin inventario</span>
                                                @endif
                                            </div>
                                        </div>
                                        @php
                                        ...
                                        <form action="{{route('single-add-to-cart')}}" method="POST" class="mt-4">
                                            ...
                                            <div class="add-to-cart">
                                                <button type="submit" class="btn">Agregar al carro</button>
