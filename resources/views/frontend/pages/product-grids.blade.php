...
@section('title', 'E-SHOP || PÁGINA DE PRODUCTO')
					...
					<div class="col-lg-9 col-md-8 col-12">
						<div class="row">
							<div class="col-12">
								...
								<!--/ Fin de la Parte Superior de la Tienda -->
							</div>
						</div>
						<div class="row">
							{{-- {{$products}} --}}
									...
									<div class="quickview-content">
										...
										<div class="quickview-ratting-review">
											<div class="quickview-ratting-wrap">
												...
												<a href="#"> ({{ $rate_count }} reseña(s) de clientes)</a>
											</div>
											<div class="quickview-stock">
												@if($product->stock > 0)
													<span><i class="fa fa-check-circle-o"></i> {{ $product->stock }} en stock</span>
												@else
													<span><i class="fa fa-times-circle-o text-danger"></i> {{ $product->stock }} agotado</span>
												@endif
											</div>
										</div>
										@php
