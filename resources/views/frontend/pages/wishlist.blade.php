...
@section('title', 'Página de Lista de Deseos')
                            ...
                            @else 
                                <tr>
                                    <td class="text-center">
                                        No hay ningún producto en la lista de deseos. <a href="{{ route('product-grids') }}" style="color: azul;">Continuar comprando</a>
                                    </td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
                    <!--/ Fin del Resumen de Compras -->
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    <!-- Inicio de un Servicio Individual -->
                    <div class="single-service">
                        <i class="ti-rocket"></i>
                        <h4>Envío Gratis</h4>
                        <p>Compras superiores a $100</p>
                    </div>
                    <!-- Fin de un Servicio Individual -->
                </div>
                <div class="col-lg-3 col-md-6 col-12">
                    <!-- Inicio de un Servicio Individual -->
                    <div class="single-service">
