...
@section('main-content')
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">Contacto</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									<h3>Escríbenos un mensaje @auth @else<span style="font-size:12px;" class="text-danger">[Necesitas iniciar sesión primero]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="email" type="email" id="email" placeholder="Ingresa la dirección de correo electrónico">
											</div>	
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Tu Teléfono<span>*</span></label>
												<input id="phone" name="phone" type="number" placeholder="Ingresa tu número de teléfono">
											</div>	
										</div>
										<div class="col-12">
											<div class="form-group message">
												<label>Tu mensaje<span>*</span></label>
												<textarea name="message" id="message" cols="30" rows="9" placeholder="Ingresa el mensaje"></textarea>
											</div>
										</div>
										<div class="col-12">
	...
	<!--/ Fin de la Sección de Mapa -->
	
	<!-- Comienza Boletín de Compra -->
	@include('frontend.layouts.newsletter')
	<!-- Termina Boletín de Compra -->
	<!--================ Éxito de Contacto =================-->
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-success">Tu mensaje se envió correctamente...</p>
			</div>
		  </div>
		</div>
	</div>
